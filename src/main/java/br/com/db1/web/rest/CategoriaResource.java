...
import br.com.db1.service.CategoriaService;
...
/**
 * REST controller for managing {@link br.com.db1.domain.Categoria}.
 */
@RestController
@RequestMapping("/api")
public class CategoriaResource {
    ...
    public ResponseEntity<List<CategoriaDTO>> getPublicAllCategorias() {
